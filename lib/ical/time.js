...
(function() {
  ...
  ICAL.Time.prototype = {
    ...
    /**
     * Calculates the week number. To get the ISO 8601 week number,
     * supply ICAL.Time.MONDAY as first argument.
     *
     * There are different systems of counting weeks. This is documented in more detail
     * for {@linkcode ICAL.Time.weekOneStarts}.
     *
    ...
    weekNumber: function weekNumber(aWeekStart, aDayOfYearInWeekOne) {
      ...
      var week = this.startOfWeek(aWeekStart); // TODO: We could return cached result for week
      var year = week.year;
   ...
   *
   * ISO 8601 defines that the first Thursday (day 4 of the ISO week
   * starting with Monday) is always in week 1, which is equivalent to
   * January 4th always being in week 1. The latter definition is used
   * by default i.e. aDayOfYearInWeekOne defaults to 4.
   *
   * Alternative definitions of where to start counting are e.g.
   * the first week that's fully in January (which means January 7th is
   * always in week one, i.e. aDayOfYearInWeekOne = 7), or
   * the first week that contains January 1st (i.e. aDayOfYearInWeekOne = 1).
   *
   * @see ICAL.Time#weekNumber
   * @param {Number} aYear                  The year to search in
   * @param {ICAL.Time.weekDay=} aWeekStart The week start weekday, used for calculation.
   * @param {Number=} aDayOfYearInWeekOne   Define this day of the year to be in week one
